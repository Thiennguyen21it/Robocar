...
#define SV_1 6 //kepj (xanh luc) center
#define SV_2 3 //len xuong (mau` vang) trai
#define SV_3 5 //toi lui (mau den) phai
...
*/
//750 is for 0 degree
//1500 means 90 degree
//2250 is for 180 degree
// int sv1Val = 1500, sv2Val = 750, sv3Val = 1795;
int sv1Val = 1125 ; //45 degree
int sv2Val = 1500
int sv3Val = 1795
